...
Route::post('report/generate', ['uses' => 'ReportController@generate']);

// SMS
Route::post('send', ['uses' => 'CommunicationController@postClient']);
Route::get('communications', ['uses' => 'CommunicationController@client']);
