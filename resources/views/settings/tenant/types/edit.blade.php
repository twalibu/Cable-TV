...
<!-- Page Header -->
@section('header')Edit Cable Type @stop

<!-- Page Description -->
@section('desc')Edit Cable Type Details @stop
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            <label class="control-label">Cable Type Name</label>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            <label class="control-label">Cable Type Amount</label>
                                            <input name="amount" type="number" value="{{ $type->amount }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            <label class="control-label">Cable Type Duration</label>
