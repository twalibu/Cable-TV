...
<!-- Page Header -->
@section('header')Add Cable Type @stop

<!-- Page Description -->
@section('desc')Create New Cable Type @stop
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            <label class="control-label">Cable Type Duration <small>(In Months)</small></label>
