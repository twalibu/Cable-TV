            ...
            <div class="box-body">
                <table id="xa" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>                
                        ...
                        <tr>
                            <td><a href="{{ route('clients.show', array($client->id)) }}">{{ $client->first_name }} {{ $client->middle_name }} {{ $client->last_name }}</a></td>
                            <td>
                                ...
                                @endif
                                Region: <b>{{ $client->region->name }}</b><br>
                            </td>
                            <td>{{ $client->cables->count() }} {{ str_plural('Cable', $client->cables->count()) }}</td>
                            <td>
                                <div class="btn-group">
