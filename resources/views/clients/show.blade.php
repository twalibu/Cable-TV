		...
		<div class="col-md-3">
	  	...
	  	<div class="box box-primary">
	    	<div class="box-body box-profile">
	      		...
	      		<p class="text-muted text-center">{{ $client->tenant->name }}</p>
	      		...
	      		<ul class="list-group list-group-unbordered">
	        		...
	        		<li class="list-group-item">
	          			<b>Region</b> 
	          			<p class="text-muted">{{ $client->region->name }}</p>
	        		</li>
	      		</ul>
	...
	<div class="col-md-9">
	  	<div class="nav-tabs-custom">
	    	<ul class="nav nav-tabs">
	      		<li class="active"><a href="#cables" data-toggle="tab">Client Cables</a></li>
	    	</ul>
	    	<div class="tab-content">
	    		<!-- Cables Tab -->
	    		<div class="tab-pane active" id="cables">
		    	 	<table id="xa" class="table table-bordered table-striped table-hover">
	                	<thead>
		                  	<tr>
			                  	<th>Cable Reference</th>
	                	...
	                	<tbody>        
		                	@foreach ($client->cables as $cable)
			                  	<tr>
				                    <td><a href="{{ route('cables.show', array($cable->id)) }}">{{ $cable->reference_id }}</a></td>
					                <td>{{ $cable->type->name }}</td>
