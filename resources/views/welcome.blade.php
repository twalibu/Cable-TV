...
<head>
    ...
    <meta name="description" content="Cable Alert Platform prompts notifications of policy expiration more effectively, quickly and intelligently to all your Clients. It is designed to transform the way we do business especially the time-based ones.">
    <meta name="keywords" content="Cable Alert , Cable-Alert, TechLegend, Insurance Solution, SAAS, Tanzania Platform">
    <meta name="author" content="TechLegend - Creative Inspiration">
     <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{{ config('app.name', 'Cable Alert') }} | Taking Care of What's Important!</title>
...
<body>
    ...
    <div id="loading-wrap">
        <div class="loading-effect">
            <img src="{{ asset('vendor/landing/assets/img/logo.png') }}" alt="Cable Alert Logo" />
        </div>
    </div>
    <!-- Loading Bar End -->
    <div id="home"></div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="left floatleft">
                            <div class="logo">
                                <a href="{{ url('/') }}"><img src="{{ asset('vendor/landing/assets/img/logo.png') }}" alt="Cable Alert" /></a>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-7 col-md-7 wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="1s">
                                <div class="left m-minus pt-20">
                                    <div class="slide-text pt-200">
                                        <h1 class="font-90 we-ex-bold white-color uppercase mb-20">Cable Alert</h1>
                                        <p class="white-color l-height-26 font-18 mb-40">Prompts notifications of subscription expiration more effectively, quickly and intelligently to all your Clients in Time!
                                        </p>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 mobile-mb-30 wow fadeInUpSmall" data-wow-delay=".3s" data-wow-duration="1s">
                    <div class="single-special">
                        ...
                        <p>Cable Alert is Designed with needs of your Client First. We take care of tidious things so you can focus on serving your Clients Better, efficiently.</p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 mobile-mb-30 wow fadeInUpSmall" data-wow-delay=".6s" data-wow-duration="1s">
                    <div class="single-special">
                        ...
                        <p>You don't have to through away all your softwares, Cable Alert merge and enhence what you already have.</p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 wow fadeInUpSmall" data-wow-delay=".9s" data-wow-duration="1s">
                    <div class="single-special">
                        ...
                        <p>Cable Alert is the gift that keeps on growing. We're continuously adding more tools that you love (making your membership even more valuable over time).</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xs-12 col-sm-8 col-md-7 wow fadeInRight" data-wow-delay=".2s" data-wow-duration="1s">
                    <div class="section-title easy-text pt-45 in-block">
                        <h1 class="mb-20">Simplify your life & streamline<br />
                                <span class="theme-color font-50 we-bold">Your business</span>
                            </h1>
                        <p class="font-15 l-height-25 mb-20">Cable Alert was created with one idea in mind: the tools you need to run your business shouldn't put you out of business.</p>

                        <p class="font-15 l-height-25 mb-25">Which is why we have created a range of subscription option so you can enjoy our most incredible offer yet without costing you an arm... (Or kuvunja Kibubu)</p>
                        <a class="btn ripple-btn" disabled=""><span><b>Subscribe Now!</b>  <i>"100% Money-Back Guarantee"</i></span></span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 text-center tablet-mb-50 wow zoomIn" data-wow-delay=".3s" data-wow-duration="1s">
                    <div class="section-title title-2 in-block mb-70">
                        ...
                        <p class="font-16 l-height-26">Cable Alert offers more than we can put down without tiring you down.
                            <br /> Here are just a few of the problems Cable Alert will solve for you:
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="left text-right mt-155 pr-28">
                        <div class="single-features pb-110 relative wow fadeInRight" data-wow-delay=".4s" data-wow-duration="1s">
                            ...
                            <p>Worried about Your Clients? The platform sends SMS notifications for every cable subscription to the client holds prior the expiration date.</p>
                        </div>
                        <div class="single-features relative wow fadeInRight" data-wow-delay=".6s" data-wow-duration="1s">
                            ...
                            <p>You want to be unique that your competitors? And since everyone’s business is at a different stage, we made sure to avoid a one-size-fits-all solution.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="right text-left mt-155 pl-28">
                        <div class="single-features pb-110 relative wow fadeInLeft" data-wow-delay=".4s" data-wow-duration="1s">
                            ...
                            <p>Yes, Information is Power... Cable Alert give you a summary of how your business is doing at a click of a button. (You dont have to sniff around pile of papers again)</p>
                        </div>
                        <div class="single-features relative wow fadeInLeft" data-wow-delay=".6s" data-wow-duration="1s">
                            ...
                            <p>Need to provide accurate and creative products? From Marketing Bulk SMS to an insurance premier calculator, We provide you will tools you need to work effectively.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="watch-area ptb-115 gradient-1 relative fix">
                ...
                <div class="col-xs-12 col-sm-8 col-md-6 col-md-offset-1 wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="1s">
                    <div class="section-title watch-text pt-45 in-block">
                        <h1 class="white-color mb-20">Premier <br />
                                <span class="font-50 we-bold">Cable Alert</span>
                            </h1>
                        <p class="font-15 l-height-25 mb-20 white-color">Your very own Custom Cable Alert! That's right, We’re giving you the all-star treatment. Just like we've done with hundreds of partners, we put your business need First!</p>
                        <a class="btn ripple-btn" href="{{ asset('vendor/landing/assets/img/logo.png') }}"><span>Get In-touch</span></a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center wow zoomIn" data-wow-delay=".3s" data-wow-duration="1s">
                    <div class="section-title title-2 in-block mb-70">
                        <h1 class="mb-25 l-height-1">Cable <span class="theme-color">Alert</span></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-5 mobile-mb-30">
                    <div class="info-text">
                        <h3 class="font-26 mb-20 in-block">Contant Info</h3>
                        ...
                        <ul class="contact-text clearfix">
                            ...
                            <li>
                                <h5 class="font-16 l-height-26 capitalize we-regular">
                                        Email: <span class="font-14 we-light"><a class="lowercase montserrat we-light" href="mailto:ask@Cable-alert.pro">ask@cable-alert.pro</a></span>
                                    </h5>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-7">
                    <div class="contact-form plr">
                        <form class="custom-input contact_form name-email" id="contact_form" action="{{ url('contact') }}" method="post">
                            ...
                            <button class="btn ripple-btn uppercase" type="submit" name="submit" id="contact_submit" data-complete-text="Well done!">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-6 col-text-center text-center">
                    <div class="footer-text">
                        <h1 class="white-color mb-35">Join Now To Our Newsletter</h1>
                        <form class="subscribe-form custom-input name-email clearfix" action="javascript:void(0)" method="post">
                            <input type="email" name="email" placeholder="Enter your Email Address" required="" />
                            <button class="font-14 btn we-regular uppercase" type="submit" name="submit" data-complete-text="Send!">
                                <i class="zmdi zmdi-mail-send"></i>
                            </button>
                        </form>
                        <div class="social-icon l-height-1 mb-25">
                            <ul class="clearfix in-block">
                                <li><a href="https://www.facebook.com/CableAlert" target="_blank"><i class="zmdi zmdi-facebook"></i></a></li>
